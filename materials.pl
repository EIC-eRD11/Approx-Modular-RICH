...
my @Agel1RefrIndex = ( 1.045, 1.045, 1.045, 1.045, 1.045,
...
my @Agel1AbsLength = ( "3.448*m",  "4.082*m",  "6.329*m",  "9.174*m",
...
my @Agel2RefrIndex = ( 1.055, 1.055, 1.055, 1.055, 1.055, 
...
my @Agel2AbsLength = ( "3.448*m",  "4.082*m",  "6.329*m",  "9.174*m",
                      "12.346*m", "13.889*m", "15.152*m", "17.241*m",
                      "18.868*m", "20.000*m", "26.316*m", "35.714*m",
                      "45.455*m", "47.619*m", "52.632*m", "52.632*m",
                      "55.556*m", "52.632*m", "52.632*m", "47.619*m",
...
sub define_material
{
	...
	$mat{"indexOfRefraction"} = arrayToString(@Agel1RefrIndex);
	$mat{"absorptionLength"}  = arrayToString(@Agel1AbsLength);
	...
	$mat{"components"}    = "Si 1 O 2";
	$mat{"photonEnergy"}      = arrayToString(@PhotonEnergyBin);
	$mat{"indexOfRefraction"} = arrayToString(@Agel2RefrIndex);
	$mat{"absorptionLength"}  = arrayToString(@Agel2AbsLength);
	print_mat(\%configuration, \%mat);
